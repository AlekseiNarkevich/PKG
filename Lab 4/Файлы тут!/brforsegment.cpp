...
void BrForSegment::paintEvent(QPaintEvent*) {
    ...
    // Настраиваем красную линию и маркеры
    painter1.setPen(QPen(Qt::red, 2));  // Толщина красной линии
    painter1.setBrush(Qt::red);  // Красные маркеры
    ...
    for (const auto &point : points) {
        ...
        double markerSize = 6;  // Размер квадрата
