...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuVariant = new QMenu(menubar);
        menuVariant->setObjectName("menuVariant");
        MainWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(MainWindow);
        statusbar->setObjectName("statusbar");
        MainWindow->setStatusBar(statusbar);

        menubar->addAction(menuVariant->menuAction());
        menuVariant->addAction(actionRGB_LAB_CMYK);
        menuVariant->addAction(actionCMYK_RGB_HSV);
        menuVariant->addAction(actionRGB_XYZ_CMYK);
        menuVariant->addAction(actionRGB_CMYK_HLS);
        menuVariant->addAction(actionRGB_XYZ_HSV);
        menuVariant->addAction(actionCMYK_LAB_XYZ);
        menuVariant->addAction(actionRGB_XYZ_LAB);
        menuVariant->addAction(actionHSV_XYZ_LAB);
        menuVariant->addAction(actionRGB_CMYK_HSV);
        menuVariant->addAction(action_RGB_HSV_LAB);
        menuVariant->addAction(actionCMYK_LAB_RGB);
        menuVariant->addAction(actionCMYK_HLS_XYZ);
        menuVariant->addAction(actionCMYK_LAB_HSV);
        menuVariant->addAction(actionXYZ_LAB_HLS);
        menuVariant->addAction(actionRGB_HLS_LAB);
        menuVariant->addAction(actionCMYK_RGB_HLS);
        menuVariant->addAction(actionRGB_XYZ_HLS);
        menuVariant->addAction(actionCMYK_XYZ_RGB);
...
"RGB \342\206\224\357\270\217 HSV \342\206\224\357\270\217 LAB ", nullptr));
        ...
        menuVariant->setTitle(QCoreApplication::translate("MainWindow", "Variant", nullptr));
    } // retranslateUi
